...
<body>
	...
	//Define variables
	$query = "SELECT * FROM  events WHERE EventName = 'Graduate Student Recital: Jasmine Jones, Soprano' "; // Select all events where the event starts between 9:00 AM and 9:00 PM
