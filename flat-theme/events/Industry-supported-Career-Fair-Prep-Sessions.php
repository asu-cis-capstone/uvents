...
<body>
	...
	//Define variables
	$query = "SELECT * FROM  events WHERE EventName = 'Industry-supported Career Fair Prep Sessions' "; // Select all events where the event starts between 9:00 AM and 9:00 PM
