...
<body>
	...
	//Define variables
	$query = "SELECT * FROM  events WHERE EventName = 'Career Services Student Focus Group Opportunity!' "; // Select all events where the event starts between 9:00 AM and 9:00 PM
