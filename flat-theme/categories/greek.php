...
<body>
    ...
    <header class="navbar navbar-inverse navbar-fixed-top wet-asphalt" role="banner">
        <div class="container">
            <div class="navbar-header">
				...
				<img class="img-responsive" src="../images/LogoDone.png" width = "130" height = "75"alt="">
				</a>
            </div>
	...
	//Only want to proceed entering the database if it is safe, that is, the page was submitted
		...
		//Define variables
		$query = "SELECT * FROM	events WHERE EventCategory LIKE '%Greek%'"; // Select statement to call data from events category based on the search criteria
