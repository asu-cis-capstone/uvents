		...
		//Declare html div body
			echo "<div class=\"container\">";		
				echo "<hgroup class=\"mb20\">";
						...
						echo "<h2 class=\"lead\"><strong class=\"text-danger\"></strong>Here are all the events in your area <strong class=\"text-danger\">Engineering</strong></h2>";
				echo "</hgroup>";			
			echo "</div>";		
